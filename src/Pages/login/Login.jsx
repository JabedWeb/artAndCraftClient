        ...
        <Col className="justify-content-center shadow p-5 my-5" md={5}>
          ...
          <div className="social_login d-flex justify-content-center flex-wrap">
            <div className="google_sign">
              <button
                style={{ backgroundColor: '#617A55', borderRadius: '4px' }}
                onClick={signInWithGoogle}
                className="btn d-flex align-items-center fw-bold px-3 my-2 py-2 text-light me-2"
              >
          ...
          <h5 className="text-center mt-2">
            Are you a new Toy seller? <Link style={{ color: '#617A55' }} className="text-decoration-none" to={'/register'}> Register</Link>
          </h5>
        </Col>
      </Row>
    </Container>
